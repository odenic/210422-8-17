  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="hr"></div>
        <div class="submit">
          <a class="btn" @click="changeShow">立即支付</a>
          <QRCodeAlert
            :codeUrl="codeUrl"
            :class="isShow ? 'show' : 'dontShow'"
...
import { getQRCode, checkPaymentState } from "@/api/pay";

import { ResQRCode } from "@/types/index";

import QRCodeAlert from "./QRCode/index.vue";
...
export default defineComponent({
  ...
  async mounted() {
    ...
    const res = ((await getQRCode(this.orderId)) as unknown) as ResQRCode;
    try {
    ...
    changeShow() {
      ...
      if (this.isShow) {
        this.timer = window.setInterval(async () => {
          try {
            await checkPaymentState(this.orderId);
